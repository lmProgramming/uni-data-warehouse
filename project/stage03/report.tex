...
Zgodnie z założeniami projektu, kostka została zbudowana w SQL Server Analysis Services (SSAS) i zawiera dane z lat 1950-2023. Umożliwia ona intuicyjne eksplorowanie danych, identyfikowanie trendów, wzorców oraz ciekawych zależności, co wspiera podejmowanie decyzji i głębsze zrozumienie dynamiki Formuły 1. Analizy pogody mogą dotyczyć tylko lat 2018-2023 z racji takiej właśnie dostępności danych.
...
\begin{enumerate}[label=\arabic*., wide, labelindent=0pt]
  ...
  \item \textbf{Win Percentage from Grid:} Procent wygranych spośród wszystkich ukończonych wyścigów.
