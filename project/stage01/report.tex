...
\begin{enumerate}[label=\arabic*., wide, labelindent=0pt]
  ...
  \item \textbf{Charakterystyka torów a wyniki:} Jak zmieniały się czasy ukończenia torów w czasie? Które tory generują najwięcej/najmniej wyprzedzeń (analiza zmiany pozycji start-meta)?
