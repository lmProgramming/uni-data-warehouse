...
Mistrzostwa Świata Formuły 1, czyli najbardziej prestiżowej serii wyścigów samochodowych na świecie.
...
\begin{itemize}[label=\textbullet, leftmargin=*]
  ...
  \item \textbf{Potrzeby analityczne:} Dostarczenie narzędzia do głębszego zrozumienia sportu, weryfikacji hipotez, tworzenia rankingów i porównań, które wykraczają poza proste tabele wyników.
...
\label{sec:zrodla_danych_poprawione}

\begin{table}[H]
  \centering
  \caption{Źródło danych: Formula 1 World Championship (1950-2023)}
  \label{tab:zrodlo_f1_pelne}
  \tiny
  \begin{tabular}{|p{0.26\linewidth}|l|r|r|p{0.3\linewidth}|}
    \hline
    ...
    \texttt{seasons.csv}                & CSV             & 75               & <0.1MB           & Info o sezonach.                                                                               \\
...
\begin{table}[H]
  \centering
  \caption{Źródło danych: F1 Weather Dataset (2018-2023)}
  \label{tab:zrodlo_pogoda_pelne}
  \tiny
  \begin{tabular}{|p{0.26\linewidth}|l|r|r|p{0.3\linewidth}|}
    \hline
    \textbf{Plik}        & \textbf{Format} & \textbf{Rekordy} & \textbf{Rozmiar} & \textbf{Opis}                                                                                                                                                         \\
...
\begin{itemize}[label=\textbullet, leftmargin=*]
  ...
  \item \textbf{Drugie źródło (Minute by Minute F1 Grand Prix Weather Data):} Ten zbiór dostarcza szczegółowych, minutowych danych pogodowych dla Grand Prix Formuły 1 w latach 2018-2023. Zawiera takie informacje jak temperatura powietrza i toru, wilgotność, ciśnienie, opady, kierunek i prędkość wiatru.
        \begin{itemize}[label=\textendash, leftmargin=1em]
          ...
          \item \textbf{Mapowanie torów (jeśli konieczne):} Wcześniejsza analiza wskazywała na potrzebę mapowania tekstowego \texttt{circuit\_id} z danych pogodowych na numeryczny \texttt{circuitId} lub tekstowy \texttt{circuitRef} z pliku \texttt{circuits.csv}. Chociaż dane pogodowe zawierają \texttt{Year} i \texttt{Round Number}, co powinno wystarczyć do jednoznacznej identyfikacji wyścigu, spójność danych o torach między źródłami warto będzie zweryfikować. Jeśli dane pogodowe nie zawierają bezpośredniego identyfikatora toru zgodnego z pierwszym źródłem, mapowanie na podstawie nazwy toru lub lokalizacji może być potrzebne dla dodatkowej weryfikacji lub wzbogacenia wymiaru toru.
        \end{itemize}
...
\begin{enumerate}[label=\arabic*., wide, labelwidth=!, labelindent=0pt]
  ...
  \item \textbf{Pogoda a nieoczekiwane wyniki (2018-2023):} Analiza, czy deszczowe wyścigi częściej przynoszą nieoczekiwane wyniki.
